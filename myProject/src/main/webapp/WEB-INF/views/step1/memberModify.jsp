...
<script src="/myProject/step1/js/memberModify.js" charset="UTF-8"></script>
</head>
<body>
	...
	<a href="step1Controller.jsp?command=list">회원 리스트 페이지</a>

	<form action="step1Controller.jsp" method="POST" id="hiddenForm">
