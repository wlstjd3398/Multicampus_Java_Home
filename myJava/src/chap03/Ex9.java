...
//		String result1 = (math1 >= 80 && eng1 >= 80) ? "합격입니다" : "불합격입니다";
//		System.out.println("exam1 = " + result1);

		boolean result1 = math1 >= 80 && eng1 >= 80;
		System.out.println("exam1 = " + (result1 ? "합격입니다" : "불합격입니다"));
				
		
		String result2 = (math1 < 80 || eng1 < 80) ? "과락인 과목이 존재합니다" : "과락인 과목이 없습니다";
		System.out.println("exam2 = " + result2);
		
		String result3_2 = !(math1 < 80 || eng1 < 80) ? "합격입니다" : "불합격입니다";
